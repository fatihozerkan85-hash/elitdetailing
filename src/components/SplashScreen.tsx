      ...
      <div style={{ perspective: 800, marginBottom: 48 }}>
        <div style={{ width: 180, height: 180, position: 'relative', transformStyle: 'preserve-3d', animation: 'coinFlip 2.5s linear infinite' }}>
          <div style={{ position: 'absolute', inset: 0, backfaceVisibility: 'hidden', WebkitBackfaceVisibility: 'hidden', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
            ...
            <img src="/branding/elit-logo.png" alt="Elite Detailing" style={{ width: '100%', height: '100%', objectFit: 'contain', filter: 'drop-shadow(0 0 20px rgba(201,168,76,0.5))' }} />
          </div>
          <div style={{ position: 'absolute', inset: 0, backfaceVisibility: 'hidden', WebkitBackfaceVisibility: 'hidden', transform: 'rotateY(180deg)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
            {/* eslint-disable-next-line @next/next/no-img-element */}
            <img src="/branding/elit-logo.png" alt="Elite Detailing" style={{ width: '100%', height: '100%', objectFit: 'contain', transform: 'scaleX(-1)', filter: 'drop-shadow(0 0 20px rgba(201,168,76,0.5)) brightness(0.75) sepia(0.4)' }} />
          </div>
        </div>
      </div>

      <h1 style={{ fontSize: 28, fontWeight: 700, letterSpacing: '0.18em', marginBottom: 8, textAlign: 'center', background: 'linear-gradient(135deg, #E8C96A 0%, #C9A84C 40%, #9A7420 100%)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', backgroundClip: 'text', fontFamily: 'var(--font-display, "Barlow Condensed", sans-serif)' }}>ELITE DETAILING</h1>
