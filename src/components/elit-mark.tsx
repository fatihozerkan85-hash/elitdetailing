...
export function ElitMark({ className }: { className?: string }) {
  ...
  return (
    ...
    >
      <defs>
        <linearGradient id={gold} x1="8" y1="4" x2="56" y2="68" gradientUnits="userSpaceOnUse">
      ...
      <path
        ...
        fill={`url(#${gold})`}
      />
      <circle cx="23.4" cy="46.2" r="2.15" fill="#0B0C0E" stroke={`url(#${gold})`} strokeWidth="1.1" />
      <circle cx="43.4" cy="46.2" r="2.15" fill="#0B0C0E" stroke={`url(#${gold})`} strokeWidth="1.1" />
    </svg>
  );
}
