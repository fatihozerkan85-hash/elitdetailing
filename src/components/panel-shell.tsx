...
const nav = [
  ...
  { href: `${ADMIN_PATH}/site`, label: "Site içeriği", icon: Settings2 },
  { href: `${ADMIN_PATH}/site/bannerlar`, label: "Bannerlar", icon: Megaphone },
  { href: `${ADMIN_PATH}/site/metinler`, label: "Metinler", icon: FileText },
